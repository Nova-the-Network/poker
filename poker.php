...
:root {
    ...
    --cream:#F5F0EA; --muted:#999; --green:#22C55E;
...
.card h2 { font-size:1rem; font-weight:800; margin-bottom:16px; text-transform:uppercase; letter-spacing:1px; font-family:'DM Mono',monospace; }

/* ── Créer partie ── */
.create-options { display:flex; flex-direction:column; gap:12px; }
.create-options label { font-size:0.82rem; font-weight:700; color:var(--muted); }
.create-options select, .create-options input {
    ...
    box-shadow:var(--sh); outline:none; background:var(--white);
}
.create-options select:focus, .create-options input:focus { border-color:var(--red); box-shadow:var(--sh); }
.btn {
    ...
    cursor:pointer; text-decoration:none; transition:transform 0.1s,box-shadow 0.1s;
    box-shadow:var(--sh);
}
.btn:hover { transform:translate(-2px,-2px); box-shadow:var(--sh-lg); }
.btn:active { transform:translate(2px,2px); box-shadow:none; }
.btn-primary { background:var(--red); color:var(--white); border-color:#b50800; box-shadow:3px 3px 0 #b50800; }
...
.session-item {
    display:flex; align-items:center; justify-content:space-between;
    padding:14px 16px; border:var(--border); border-radius:12px;
    background:var(--white); box-shadow:var(--sh); transition:transform 0.1s;
}
.session-item:hover { transform:translate(-2px,-2px); box-shadow:var(--sh-lg); }
.session-info { display:flex; flex-direction:column; gap:2px; }
.session-host { font-weight:800; font-size:0.9rem; }
.session-meta { font-size:0.78rem; color:var(--muted); font-weight:600; font-family:'DM Mono',monospace; }
.session-status {
    font-size:0.72rem; font-weight:800; text-transform:uppercase;
    padding:4px 10px; border-radius:6px;
}
.status-waiting { background:#FEF3C7; color:#92400E; }
.status-playing { background:var(--red); color:var(--white); }
.status-finished { background:var(--black); color:var(--white); opacity:0.5; }
.btn-delete {
    background:transparent; border:none; cursor:pointer;
    font-size:1.1rem; color:#999; padding:4px 8px; border-radius:6px;
...
.stat-box {
    text-align:center; padding:14px; border:var(--border); border-radius:10px;
    background:var(--cream); box-shadow:var(--sh);
}
.stat-number { font-size:1.6rem; font-weight:900; color:var(--black); }
.stat-label { font-size:0.7rem; font-weight:700; color:var(--muted); text-transform:uppercase; letter-spacing:1px; font-family:'DM Mono',monospace; margin-top:2px; }
.no-sessions { color:var(--muted); font-weight:600; font-size:0.9rem; text-align:center; padding:20px; }
...
.invite-box code { font-weight:800; font-size:1.1rem; color:var(--black); }
.qr-placeholder {
    width:128px; height:128px; margin:10px auto;
    background:var(--white); border:2px solid var(--black); border-radius:8px;
    display:flex; align-items:center; justify-content:center;
    overflow:hidden;
}
.qr-placeholder canvas, .qr-placeholder img { max-width:100%; max-height:100%; }
